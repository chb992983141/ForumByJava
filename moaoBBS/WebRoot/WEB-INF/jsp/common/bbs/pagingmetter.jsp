...
<div class="fenye">
        ...
        <span id="fatie">
        	...
        	<c:if test="${landinguser.power!=0}">
	        <a href='javascript:void(0)' onclick='openDialog("reply");'> <img src="${pageContext.request.contextPath }/images/bbs/huifu.png"/></a>
	        </c:if>
	        <c:if test="${landinguser.power==0}">
	        <a  href="javascript:void(0)" onclick="showPanel();"> <img src="${pageContext.request.contextPath }/images/bbs/huifu.png"/></a>
	        </c:if></span>
</div>