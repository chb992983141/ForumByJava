	...
	<div class="blogs_main">
		...
		<div class="mood_box">
				<div class="blogs_publish_mood">
					<form action="<%=path%>/blogs/mood!addMood.action" method="post">
						<textarea id="content1" class="content" name="blogsMood.mood"></textarea>
						<input type="hidden" name="blogsMood.user_id" value="1">
                        ...
                        <li class="logli3">
                           <table width="965" border="0" >
                               ...
                               <tr>
                                  ...
                                  <td width="688">
                                        <div class="person_leaveword5"><span><a>编辑</a>|<a>删除</a></span><a href="#">moao-->${l.user_id}</a> 2012-08-12 12:10</div>
                                       ...
                                       ${l.mood}
                                        ...
                                        <ul>
                                        	<li>moao-->${c.user_id } 2016-06-06 12:00</li>
	                                 ...
	                                 <div class="comm">
							<form class="myform" action="<%=path %>/blogs/comment!addMood.action" method="post">
				...
				<div class="fenye">
					<a
						href="<%=path %>/blogs/mood!getFenYe.action?pageNum=${pageNum-1}">&lt;&lt;上一页</a>
					<a
						href="/moaoBBS/blogs/mood!getFenYe.action?pageNum=${pageNum +1}">下一页&gt;&gt;</a>
				</div>
			</div>
		</div>
