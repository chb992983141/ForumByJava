...
<body>
	...
	<div class="blogs_main">
		...
		<div class="center">
				...
				<s:iterator var="l" value="#request.list">
					<div class="center_group">
						<div class="center_group2">
							<a
								href="<%=path %>/blogs/photo!selectPhotoByGroupId.action?blogsphotogroup.id=${l.id}"><img
								alt="" src="<%=path%>/images/blogs/photo/${l.cover}"> </a> <br />
						</div>
			...
			<div class="feny">
       			 <ul class="nav">
       			<li id="shouye"><a href="<%=path %>/blogs/photogroup!getFenYe.action?pageNum=${pageNum-1}">&#171;上页</a></li>
      		  	<li id="gettosecond"><a href="<%=path %>/blogs/photogroup!getFenYe.action?pageNum=${pageNum +1}">&nbsp;&nbsp; 下页&raquo;&nbsp;　</a></li>
      		  	</ul>
			</div>
			</div>
			</div>
	...
	<div class="tananswer">
		<span class="close"></span><span id="reply">添加新图片</span>
		 <form action="<%=path %>/blogs/uploadGroup.action?blogsphotogroup.id=${blogsphotogroup.id}" method="post" enctype="multipart/form-data">
